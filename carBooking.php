    ...
    <div class="container-fluid header filerBrighness">
        <div class="d-flex justify-content-center align-items-center flex-column">
            <div class="form_border">
                ...
                <form class="mt-3 car_booking_form" style="width: 450px;">
                    <div class="mb-3">
                        <!-- <label for="carName" class="form-label">Car Name</label> -->
                        <input type="email" class="form-control" id="carName" value="mahendra" disabled>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-10 mb-3">
                            <!-- <label for="pickup" class="form-label">Pickup Point</label> -->
                            <select id="pickup" class="form-select">
                        ...
                        <div class="col-md-6 col-sm-10 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="pDateTime">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-10 mb-3">
                            <!-- <label for="dropOff" class="form-label">Drop Off Point</label> -->
                            <select id="dropOff" class="form-select">
                        ...
                        <div class="col-md-6 col-sm-10 mb-3">
                            ...
                            <input type="datetime-local" class="form-control" id="dDateTime" placeholder="date">
                        </div>
                    </div>
                    <div class="mb-3">
